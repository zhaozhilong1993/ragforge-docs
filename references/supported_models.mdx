...
A complete list of models supported by RAGForge, which will continue to expand.
...
:::note
The list of supported models is extracted from [this source](https://github.com/infiniflow/ragforge/blob/main/rag/llm/__init__.py) and may not be the most current. For the latest supported model list, please refer to the Python file.
:::

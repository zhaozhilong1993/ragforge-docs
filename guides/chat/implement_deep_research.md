...
From v0.17.0 onward, RAGForge supports integrating agentic reasoning in an AI chat. The following diagram illustrates the workflow of RAGForge's deep research:
